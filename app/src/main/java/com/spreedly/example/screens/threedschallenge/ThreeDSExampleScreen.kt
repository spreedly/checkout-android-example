...
import com.spreedly.example.viewmodel.threeDSExampleViewModel
 ...
 */
@Composable
fun ThreeDSExampleScreen(
    modifier: Modifier = Modifier,
    viewModel: ThreeDSExampleViewModel = threeDSExampleViewModel(),
) {
    ...
    Scaffold(
        ...
        // This matches iOS SDK's DoChallengeIfNeeded approach
...
private fun HeaderSection() {
    Card(
        ...
        Column(
            ...
            Text(
                text = "Gateway-specific 3DS: select a product and payment method, then complete " +
                    "the gateway challenge flow.",
